...
func _input(event):
	if event is InputEventMouseMotion:
		...
		print("sub_viewport_size:", sub_viewport_size)
		print("texture_rect_size:", texture_rect_size)
		
		# recalculate ratio for screen size (0,0) divide by texture rect size (0,0)
